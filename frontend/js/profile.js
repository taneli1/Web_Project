...
const editName = document.querySelector(
    'form[id=\'editProfile\'] input[name=\'editUserName\']');
const editCity = document.querySelector(
    'form[id=\'editProfile\'] input[name=\'editCity\']');
const editEmail = document.querySelector(
    'form[id=\'editProfile\'] input[name=\'editEmail\']');
const editPhoneNumber = document.querySelector(
    'form[id=\'editProfile\'] input[name=\'editPhoneNumber\']');
